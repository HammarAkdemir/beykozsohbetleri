...
export function LiveQuestions(){
 ...
 return <section className="live-questions"><header><HelpCircle/><div><h2>Sorular</h2><p>Yayın sırasında sorunuzu gönderin. Onaylanan sorular yayınlanacaktır.</p></div></header>
